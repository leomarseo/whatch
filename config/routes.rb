Rails.application.routes.draw do
  ...
  patch '/history/movie/update/:id', to: 'saved_movies#history_update', as: 'history_update' # change rating button SHOW (switch)
  patch '/history/movie/update_like/:id', to: 'saved_movies#history_update_like', as: 'history_update_like' # change rating button SHOW (like)
  patch '/history/movie/update_dislike/:id', to: 'saved_movies#history_update_dislike', as: 'history_update_dislike' # change rating button SHOW (dislike)
